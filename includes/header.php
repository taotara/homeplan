<header class="site-header">
    <div class="container-fluid">
        <a href="dashboard.php" class="site-logo">
            <img class="hidden-md-down" src="images/logo2.png" alt="">
                ...
                <div class="site-header-shown">
                    <div class="dropdown user-menu">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
                            ...
                            <a class="dropdown-item" href="notifications.php"><span class="font-icon glyphicon glyphicon-cog"></span>Notifications</a>
                            <a class="dropdown-item" href="contact.php"><span class="font-icon glyphicon glyphicon-question-sign"></span>Help</a>
